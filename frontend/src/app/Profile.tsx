        ...
        <div className="grid grid-cols-[1fr_61.8%] gap-4">
          <div className="flex flex-col gap-4">
            <Card withBorder shadow="sm" radius="lg">
              ...
              <div className="flex flex-col gap-4 pt-4">
                <Card.Section inheritPadding className="aspect-square max-h-[300px] overflow-hidden">
                  <img src={profile.image} className="h-full w-full rounded-md object-contain" alt="profile picture" />
                </Card.Section>
            ...
            <Card withBorder shadow="sm" radius="lg">
              ...
              <div className="flex flex-col gap-4 pt-4">
                <Card.Section inheritPadding className="flex flex-col gap-4 aspect-video">
                  <MapContainer
                    center={pizzaCompanies.find((x) => x.isYourCompany == true)!.latLng as LatLngTuple}
                    ...
                    {pizzaCompanies.map((p) => (
                      <Marker
                        ...
                        icon={icon({
                          ...
                          shadowUrl: p.isYourCompany ? '/green.png' : '/red.png',
                          shadowSize: [44, 44],
                        })}
                      >
              ...
              <div className="mb-2 flex flex-col gap-4 px-4 py-4">
                <Card.Section>
                  <div className="grid grid-cols-5 items-center gap-2">
                    <div className="col-span-3 items-start font-semibold">Company Name</div>
                    <div className="col-span-1 items-center font-semibold">Industry Rank</div>
                    <div className="col-span-1 items-center font-semibold">Platform Rank</div>
                    ...
                    {pizzaCompanies.map((c, i) => (
                      <>
                        <div className="col-span-3 flex items-center ">
                          {i + 1}.{'  '}
                          {c.name}
                          {c.isYourCompany && <Badge className="ml-2 outline outline-1">Your Company</Badge>}
                        </div>
          ...
          <div className="flex flex-col gap-4 ">
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="col-span-1">
                <RankingCard rank={20000} type="Total No of Customers" isRank={false} />
              </div>
              <div className="col-span-1">
                <RankingCard rank={24} type="Total Product Types" isRank={false} />
              </div>
            </div>
            ...
            <Card withBorder shadow="sm" radius="lg">
              ...
              <div className="flex flex-col gap-4 pt-4">
                <Card.Section inheritPadding className="m-auto grid-cols-12 gap-2" sx={{ display: 'grid' }}>
                ...
                <Card.Section inheritPadding>
                  <ul className="mx-6 list-decimal">
                    <li>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel earum temporibus, deserunt rem nobis
                      ullam!
                    </li>
                    <li>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel earum temporibus, deserunt rem nobis
