        ...
        <div className="grid w-full grid-cols-3 gap-4 ">
          ...
          <div className="col-span-2 grow py-2">
            <div className="flex flex-col">
              ...
              {changeType === "None" ? (
                <div className="col-span-3 flex items-center justify-start text-gray-400">
                ...
                <div className="col-span-3 flex items-center justify-start text-green-400">
                ...
                <div className="col-span-3 flex items-center justify-start text-red-400">
